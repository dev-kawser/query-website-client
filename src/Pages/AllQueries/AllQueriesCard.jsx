...
const AllQueriesCard = ({ data }) => {
    ...
    const { productName, userInfo, brandName, queryTitle, productPhoto, boycottDetails, date, recommendationCount, _id } = data;
            ...
            <div className="space-y-7">
                <div className="space-y-2">
                    ...
                    <div className="flex items-center text-sm justify-between">
                        <span>{date}</span>
                        <span>Recommendation Count: <span className="text-red-500 font-semibold">{recommendationCount}</span></span>
                    </div>
                </div>
                <div className="space-y-2">
