            ...
            <div className="space-y-7">
                ...
                <div className="space-y-2">
                    <a rel="noopener noreferrer" href="#" className="block">
                        <h3 className="text-xl font-semibold dark:text-violet-600 overpass">{queryTitle}</h3>
                    </a>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <Link to={`/UpdateQuery/${_id}`}>
                        <button type="button" className="px-8 py-3 font-semibold border-2 rounded lg:flex hidden hover:scale-105 transition-all">Update</button>
                    </Link>
