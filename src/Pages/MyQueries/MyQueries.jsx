                ...
                <div>
                    <div className="w-full bg-center bg-cover bg-no-repeat bg-[url('https://i.ibb.co/y59xWmf/gilles-lambert-pb-l-F8-VWa-PU-unsplash.jpg')] container mx-auto my-10 dark:bg-gray-500">
                        <div className="container flex flex-col content-center justify-center p-4 py-20 max-w-7xl mx-auto md:p-10">
                            <h1 className="text-5xl antialiased font-semibold leading-none text-center dark:text-gray-300">Have a Question? Share it Here and Lets Find the Solution Together</h1>
