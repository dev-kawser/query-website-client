...
const Navbar = () => {
    ...
    const links =
        <>
            ...
            <li className="group flex  cursor-pointer flex-col">
                <NavLink className={({ isActive }) => isActive ? 'text-sky-500 font-bold ' : 'font-semibold hover:scale-105'} to='/allReview' > Reviews </NavLink> <span className="hidden lg:block mt-[2px] h-[3px] w-[0px] rounded-full bg-sky-500 transition-all duration-300 group-hover:w-full"></span>
            </li>
            {
                user ?
                    <>
