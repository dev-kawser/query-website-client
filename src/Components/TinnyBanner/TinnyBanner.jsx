...
const TinnyBanner = () => {
    return (
        <div>
            <div className="w-full bg-center bg-cover bg-no-repeat bg-[url('https://i.ibb.co/y59xWmf/gilles-lambert-pb-l-F8-VWa-PU-unsplash.jpg')] container mx-auto mt-10 lg:mt-20">
